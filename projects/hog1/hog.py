...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while score0 < goal and score1 < goal:
        if who==0:
            ...
            roundscore = take_turn(num_rolls, score1, dice) 
            score0 = score0 + roundscore
        ...
        if who==1:
            ...
            roundscore = take_turn(num_rolls, score0, dice) 
            score1 = score1 + roundscore
            if is_prime(score0 + score1):
                if score0 > score1:
                    score0 = score0 + roundscore
...
def make_averaged(fn, num_samples=1000):
    ...
    def averager(*args):
        ...
        while rolls <= num_samples:
            dicesum = fn(*args) + dicesum
            rolls +=1
        return dicesum/num_samples
    return averager
...
def max_scoring_num_rolls(dice=six_sided):
    ...
    oldscore = 0
    while num_rolls <=10:
        score = make_averaged(roll_dice, 1000)(num_rolls, dice)
        if score > oldscore:
            oldscore = score
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    ones = opponent_score % 10
    tens = ((opponent_score-ones)//10)
    if margin <= (ones+1) or margin <= (tens+1):
        num_rolls = 0
    return num_rolls
...
def prime_strategy(score, opponent_score, margin=8, num_rolls=5):
    ...
    ifzeroscore = max(ones, tens) + 1
    if is_prime(totalscore + ifzeroscore):
        if (score+ifzeroscore) > opponent_score:
            num_rolls = 0
    else:
        if margin <= (ones+1) or margin <= (tens+1):
            num_rolls = 0
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score == 0:
        ...
        return prime_strategy(score, opponent_score, margin=8, num_rolls=5)
