...
def pingpong(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    def value(amount, n, counternumber, plusorminus):
        if counternumber == n:
            return amount
        elif has_seven(counternumber + 1) or (counternumber + 1) % 7 ==0:
            return value(amount + plusorminus, n, counternumber + 1, -plusorminus)
        else:
            return value(amount + plusorminus, n, counternumber+1, plusorminus)
...
def count_change(amount):
    ...
    def ways(amount, n):
        if amount == 0:
            ...
            return ways(amount - n, n) + ways(amount, 2*n)
